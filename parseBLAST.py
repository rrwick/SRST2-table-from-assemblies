...
The allele name "allele" is extracted from the query name and is modified according to the logical variable unique_allele_symbols in srst2_table_from_assemblies.
"""
